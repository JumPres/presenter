...
async function createWindow() {
    ...
    win.loadURL('http://127.0.0.1:45549')
...
module.exports = {
    "create": function(electronBlob) {
        if (process.argv.includes('--disable-viewer')) {
            console.log('Will not start JumPres viewer due to process args, view JumPres at http://localhost:45549');
        } else {
            main(electronBlob);
        }
    }
